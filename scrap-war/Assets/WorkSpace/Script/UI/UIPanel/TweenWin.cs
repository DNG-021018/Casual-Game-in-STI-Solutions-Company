...
public class TweenWin : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        TryAgainButton?.onClick.AddListener(TryAgainButtonClickedHandler);
    }
    void OnDisable()
    {
        BackButton?.onClick.RemoveListener(BackButtonClickedHandler);
        TryAgainButton?.onClick.RemoveListener(TryAgainButtonClickedHandler);
    }
    ...
    public void TryAgainButtonClickedHandler()
    {
