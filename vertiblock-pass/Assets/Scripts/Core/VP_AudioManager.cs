...
namespace VertiblockPass
{
    ...
    {
        public static VP_AudioManager Instance { get; private set; }

        [Header("Audio Sources")]
        [SerializeField] AudioSource bgmSource;
        [SerializeField] VP_UISfxPool sfxPool;
        ...
        void LoadSettings()
        {
            _musicEnabled = PlayerPrefs.GetInt(VP_SafetyKey.KEY_MUSIC_ON, 1) == 1;
            _sfxEnabled = PlayerPrefs.GetInt(VP_SafetyKey.KEY_SFX_ON, 1) == 1;
            _musicVolume = PlayerPrefs.GetFloat(VP_SafetyKey.KEY_MUSIC_VOLUME, 1f);
            _sfxVolume = PlayerPrefs.GetFloat(VP_SafetyKey.KEY_SFX_VOLUME, 1f);
        }
        ...
        public void SetMusicEnabled(bool enabled)
        {
            ...
            PlayerPrefs.SetInt(VP_SafetyKey.KEY_MUSIC_ON, enabled ? 1 : 0);
            PlayerPrefs.Save();
            ApplyMusicSettings();
        }
        ...
        public void SetMusicVolume(float volume)
        {
            ...
            PlayerPrefs.SetFloat(VP_SafetyKey.KEY_MUSIC_VOLUME, _musicVolume);
            PlayerPrefs.Save();
            ApplyMusicSettings();
        }
        ...
        {
            _sfxEnabled = enabled;
            PlayerPrefs.SetInt(VP_SafetyKey.KEY_SFX_ON, enabled ? 1 : 0);
            PlayerPrefs.Save();
        }
        ...
        public void SetSfxVolume(float volume)
        {
            ...
            PlayerPrefs.SetFloat(VP_SafetyKey.KEY_SFX_VOLUME, _sfxVolume);
            PlayerPrefs.Save();
        }
        ...
        internal void PlaySfx(object boxMove)
        {
