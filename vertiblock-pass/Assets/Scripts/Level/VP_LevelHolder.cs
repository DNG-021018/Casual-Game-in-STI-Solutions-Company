...
{
    public class VP_LevelHolder : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            for (int i = 0; i < _GroundGroup.Length; i++)
            {
                ...
                _GroundGroup[i].position += Vector3.down * _groundPosMultiplier;
            }
        ...
        void Start()
        {
            VP_GameManager.Instance.SetState(GameState.InitializeLevel);
            SequenceSpawn();
        }
