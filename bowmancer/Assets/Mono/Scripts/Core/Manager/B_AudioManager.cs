...
namespace Bowmancer
{
    public class B_AudioManager : Singleton<B_AudioManager>
    {
        [Header("Audio Sources")]
        [SerializeField] AudioSource bgmSource;
        [SerializeField] B_UISfxPool sfxPool;
        ...
        void LoadSettings()
        {
            _musicEnabled = PlayerPrefs.GetInt(B_SafetyKey.KEY_PLAYPREF_MUSIC_ON, 1) == 1;
            _sfxEnabled = PlayerPrefs.GetInt(B_SafetyKey.KEY_PLAYPREF_SFX_ON, 1) == 1;
            _musicVolume = PlayerPrefs.GetFloat(B_SafetyKey.KEY_PLAYPREF_MUSIC_VOLUME, 1f);
            _sfxVolume = PlayerPrefs.GetFloat(B_SafetyKey.KEY_PLAYPREF_SFX_VOLUME, 1f);
        }
        ...
        public void SetMusicEnabled(bool enabled)
        {
            ...
            PlayerPrefs.SetInt(B_SafetyKey.KEY_PLAYPREF_MUSIC_ON, enabled ? 1 : 0);
            PlayerPrefs.Save();
            ApplyMusicSettings();
        }
        ...
        public void SetMusicVolume(float volume)
        {
            ...
            PlayerPrefs.SetFloat(B_SafetyKey.KEY_PLAYPREF_MUSIC_VOLUME, _musicVolume);
            PlayerPrefs.Save();
            ApplyMusicSettings();
        }
        ...
        {
            _sfxEnabled = enabled;
            PlayerPrefs.SetInt(B_SafetyKey.KEY_PLAYPREF_SFX_ON, enabled ? 1 : 0);
            PlayerPrefs.Save();
        }
        ...
        public void SetSfxVolume(float volume)
        {
            ...
            PlayerPrefs.SetFloat(B_SafetyKey.KEY_PLAYPREF_SFX_VOLUME, _sfxVolume);
            PlayerPrefs.Save();
        }
