...
{
    public class bJakGZQ3_CharacterAttackState : bJakGZQ3_ACharacterState
    {
        public override void Enter(bJakGZQ3_IStateMachine stateMachine)
        {
            ...
            characterStateMachine.StartCoroutine(WaitForEndAnimation("Attack", () => SwitchState(EntityState.Idle)));
        }
