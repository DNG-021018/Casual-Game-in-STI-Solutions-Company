...
namespace CataFury
{
    [CreateAssetMenu(fileName = "Currency Manager", menuName = CF_SafetyKey.KEY_GAME_NAME + "/Currency Manager")]
    public class CF_CurrencyManager : ScriptableObject
    {
        [Serializable]
        ...
        private void SaveData()
        {
            ...
            PlayerPrefs.SetString(CF_SafetyKey.Data.COIN_SAVE_KEY, json);
            PlayerPrefs.Save();
        }
