...
namespace CataFury
{
    public class CF_AudioManager : MonoBehaviour
    {
        [Header("Audio Sources")]
        [SerializeField] AudioSource bgmSource;
        [SerializeField] CF_UISfxPool sfxPool;
        ...
        void LoadSettings()
        {
            _musicEnabled = PlayerPrefs.GetInt(CF_SafetyKey.Data.KEY_PLAYPREF_MUSIC_ON, 1) == 1;
            _sfxEnabled = PlayerPrefs.GetInt(CF_SafetyKey.Data.KEY_PLAYPREF_SFX_ON, 1) == 1;
            _musicVolume = PlayerPrefs.GetFloat(CF_SafetyKey.Data.KEY_PLAYPREF_MUSIC_VOLUME, 1f);
            _sfxVolume = PlayerPrefs.GetFloat(CF_SafetyKey.Data.KEY_PLAYPREF_SFX_VOLUME, 1f);
        }
        ...
        public void SetMusicEnabled(bool enabled)
        {
            ...
            PlayerPrefs.SetInt(CF_SafetyKey.Data.KEY_PLAYPREF_MUSIC_ON, enabled ? 1 : 0);
            PlayerPrefs.Save();
            ApplyMusicSettings();
        }
        ...
        public void SetMusicVolume(float volume)
        {
            ...
            PlayerPrefs.SetFloat(CF_SafetyKey.Data.KEY_PLAYPREF_MUSIC_VOLUME, _musicVolume);
            PlayerPrefs.Save();
            ApplyMusicSettings();
        }
        ...
        {
            _sfxEnabled = enabled;
            PlayerPrefs.SetInt(CF_SafetyKey.Data.KEY_PLAYPREF_SFX_ON, enabled ? 1 : 0);
            PlayerPrefs.Save();
        }
        ...
        public void SetSfxVolume(float volume)
        {
            ...
            PlayerPrefs.SetFloat(CF_SafetyKey.Data.KEY_PLAYPREF_SFX_VOLUME, _sfxVolume);
            PlayerPrefs.Save();
        }
