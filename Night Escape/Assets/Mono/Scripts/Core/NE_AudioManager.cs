...
namespace NightEscape
{
    ...
    public class NE_AudioManager : MonoBehaviour
    {
        public static NE_AudioManager Instance { get; private set; }

        [Header("Audio Sources")]
        [SerializeField] AudioSource bgmSource;
        [SerializeField] NE_UISfxPool sfxPool;
        ...
        void LoadSettings()
        {
            _musicEnabled = PlayerPrefs.GetInt(NE_SafetyKey.KEY_MUSIC_ON, 1) == 1;
            _sfxEnabled = PlayerPrefs.GetInt(NE_SafetyKey.KEY_SFX_ON, 1) == 1;
            _musicVolume = PlayerPrefs.GetFloat(NE_SafetyKey.KEY_MUSIC_VOLUME, 1f);
            _sfxVolume = PlayerPrefs.GetFloat(NE_SafetyKey.KEY_SFX_VOLUME, 1f);
        }
        ...
        public void SetMusicEnabled(bool enabled)
        {
            ...
            PlayerPrefs.SetInt(NE_SafetyKey.KEY_MUSIC_ON, enabled ? 1 : 0);
            PlayerPrefs.Save();
            ApplyMusicSettings();
        }
        ...
        public void SetMusicVolume(float volume)
        {
            ...
            PlayerPrefs.SetFloat(NE_SafetyKey.KEY_MUSIC_VOLUME, _musicVolume);
            PlayerPrefs.Save();
            ApplyMusicSettings();
        }
        ...
        {
            _sfxEnabled = enabled;
            PlayerPrefs.SetInt(NE_SafetyKey.KEY_SFX_ON, enabled ? 1 : 0);
            PlayerPrefs.Save();
        }
        ...
        public void SetSfxVolume(float volume)
        {
            ...
            PlayerPrefs.SetFloat(NE_SafetyKey.KEY_SFX_VOLUME, _sfxVolume);
            PlayerPrefs.Save();
        }
