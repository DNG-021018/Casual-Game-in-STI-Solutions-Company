...
{
    public class DZ_PauseMenu : DZ_UIPage
    {
        [Header("Button")]
        [SerializeField] DZ_UIButton resumeButton;
        ...
        private void OnEnable()
        {
            if (resumeButton != null)
                resumeButton.Bind(() => { parent.Back(); _gameManager.SetState(GameState.Play); });
        ...
        {
            if (resumeButton != null) resumeButton.UnBind();
