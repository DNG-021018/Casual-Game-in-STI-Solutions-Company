...
{
    [CreateAssetMenu(fileName = "Daily Reward Manager", menuName = DZ_SafetyKey.KEY_GAME_NAME + "/Daily Reward Manager")]
    public class DZ_DailyRewardManager : ScriptableObject
    {
        [SerializeField] private DZ_CurrencyManager _currencyManager;
        ...
        {
            string json = PlayerPrefs.GetString(DZ_SafetyKey.DAILY_REWARD_SAVE_KEY, "");
        ...
        void SaveData()
        {
            ...
            PlayerPrefs.SetString(DZ_SafetyKey.DAILY_REWARD_SAVE_KEY, json);
            PlayerPrefs.Save();
        }
        ...
        {
            PlayerPrefs.DeleteKey(DZ_SafetyKey.DAILY_REWARD_SAVE_KEY);
            saveData = new DailyRewardData();
        }
    }
